...
__published:	// IDE-managed Components
	...
	TEdit *IDNP;
	TEdit *TELSTUD;
	TDateTimePicker *DATESTUD;
	TPanel *Panel13;
	TDBGrid *DBGrid3;
	TComboBox *GRUPNAME;
	TComboBox *Edit5;
	TComboBox *STGRUPEDIT;
	...
	void __fastcall Cautare_BClick(TObject *Sender);
	void __fastcall GSTUDChange(TObject *Sender);
	void __fastcall DATESTUDChange(TObject *Sender);
	void __fastcall BitBtn2Click(TObject *Sender);
	void __fastcall DBGrid3DblClick(TObject *Sender);
	void __fastcall BitBtn1Click(TObject *Sender);
	void __fastcall Panel13Resize(TObject *Sender);
	void __fastcall SEARCHSKeyUp(TObject *Sender, WORD &Key, TShiftState Shift);
	void __fastcall SEARCHGKeyUp(TObject *Sender, WORD &Key, TShiftState Shift);
...
class InputL{
  public:	 AnsiString userInput;
             AnsiString dbParam;

	  InputL(AnsiString dbParam,AnsiString userInput)
	 {
